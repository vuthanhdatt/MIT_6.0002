    ...
    def __init__(self, width, height, dirt_amount):
        ...
        for w in range(math.floor(width)):
            for h in range(math.floor(height)):  
                self.tiles[(w,h)] = self.dirt        #Init room full of dirty
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        speed = self.speed
        new_pos = self.get_robot_position().get_new_position(direction, speed)
...
#       of a 20x20 room?
#   The Standard Robot have a little bit faster than Faulty Robot, the difference
#   decrease when bumber of Robot increase
#
